      ...
      <div className="bg-white/80 backdrop-blur-md shadow-2xl rounded-2xl p-8 w-full max-w-3xl border border-blue-300">
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div className="grid md:grid-cols-2 gap-4">
            <div>
              <label className="label-text font-semibold text-blue-700">
                আবেদনকারীর নাম:
              </label>
              <input
                type="text"
          ...
          {/* বর্তমান ঠিকানা */}
          <div>
            <h2 className="font-bold text-blue-600 mt-3 mb-2">
              বর্তমান ঠিকানা:
            </h2>
            <div className="grid md:grid-cols-2 gap-4">
              <div>
          ...
          <div className="pt-4">
            <button className="btn bg-blue-600 hover:bg-blue-700 text-white w-full text-lg font-semibold tracking-wide transition-all">
              সাবমিট কর
            </button>
          </div>
        </form>
